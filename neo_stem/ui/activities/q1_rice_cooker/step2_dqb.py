...
class Step2DQB(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        questions = [
            "Nước biến thành hơi ở nhiệt độ bao nhiêu?",
            "Tại sao bọt khí nổi lên khi nước sôi?",
            "Hơi nước có thể nhìn thấy không?",
            "Tại sao nắp nồi bị đẩy lên?",
            "Phân tử nước di chuyển như thế nào khi nóng?",
        ]
