...
class Step4Model(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QtWidgets.QLabel("Mô hình: Nước sôi trong nồi")
        title.setAlignment(QtCore.Qt.AlignHCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 700;")

        description = QtWidgets.QLabel(
            "Kéo các ô vào đúng thứ tự để giải thích tại sao nắp nồi cơm điện rung và có hơi nước.")
        ...
        self._drop_labels = ["Ban đầu", "Nguyên nhân", "Vi mô", "Hiện tượng", "Kết quả"]
    ...
    def _setup_items(self) -> None:
        self._correct_sequence = [
            ("liquid", "Nước lỏng"),
            ("heat", "Nhiệt tăng"),
            ("fast_mol", "Phân tử nhanh"),
            ("boil", "Bay hơi / Sôi"),
            ("steam", "Hơi nước"),
        ]
        distractors = [
            ("freeze", "Đóng băng"),
            ("disappear", "Nước mất đi"),
            ("pressure_down", "Áp suất giảm"),
        ]
        items = self._correct_sequence + distractors
