...
class Step2DQB(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        questions = [
            "Muối ảnh hưởng tế bào thực vật thế nào?",
            "Thẩm thấu là gì?",
            "Rễ cây đước khác rễ cây thường ra sao?",
            "Cây đước lọc muối bằng cách nào?",
            "Nước di chuyển vào/ra tế bào theo quy luật gì?",
        ]
