...
class Step4Model(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QtWidgets.QLabel("Mô hình: Ngưng tụ trên ly đá")
        title.setAlignment(QtCore.Qt.AlignHCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 700;")

        description = QtWidgets.QLabel("Sắp xếp các bước giải thích tại sao bên ngoài ly đá có giọt nước.")
        ...
        self._drop_labels = ["Bước 1", "Bước 2", "Điều kiện", "Quá trình", "Kết quả"]
    ...
    def _setup_items(self) -> None:
        self._correct_sequence = [
            ("cold_glass", "Đá làm lạnh ly"),
            ("air_contact", "Không khí ẩm chạm ly"),
            ("below_dew", "Nhiệt < Điểm sương"),
            ("condense", "Hơi nước ngưng tụ"),
            ("droplets", "Giọt nước bám ngoài"),
        ]
        distractors = [
            ("leak", "Nước rò rỉ từ ly"),
            ("evaporate", "Nước bay hơi"),
            ("ice_melt", "Đá tan thấm qua ly"),
        ]
