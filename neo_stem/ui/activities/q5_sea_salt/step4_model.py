...
class Step4Model(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QtWidgets.QLabel("Mô hình: Tách muối bằng bay hơi")
        title.setAlignment(QtCore.Qt.AlignHCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 700;")

        description = QtWidgets.QLabel("Sắp xếp các bước giải thích quá trình lấy muối từ nước biển.")
        ...
        self._drop_labels = ["Nguyên liệu", "Năng lượng", "Quá trình", "Trung gian", "Sản phẩm"]
    ...
    def _setup_items(self) -> None:
        self._correct_sequence = [
            ("seawater", "Nước biển (hỗn hợp)"),
            ("sun_heat", "Nhiệt mặt trời"),
            ("evaporate", "Nước bay hơi"),
            ("saturate", "Dung dịch bão hòa"),
            ("crystal", "Muối kết tinh"),
        ]
        distractors = [
            ("filter", "Lọc qua giấy"),
            ("salt_evap", "Muối bay hơi"),
            ("cool_down", "Làm lạnh nước"),
        ]
