...
class Step4Model(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QtWidgets.QLabel("Mô hình: Chu trình sương mù Đà Lạt")
        title.setAlignment(QtCore.Qt.AlignHCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 700;")

        description = QtWidgets.QLabel(
            "Sắp xếp các bước giải thích tại sao Đà Lạt có sương mù sáng sớm và tan khi trưa.")
        ...
        self._drop_labels = ["Đêm", "Sáng sớm", "5-7h", "8-10h", "Trưa"]
    ...
    def _setup_items(self) -> None:
        self._correct_sequence = [
            ("night_cool", "Đêm: không khí lạnh"),
            ("condense", "Hơi nước ngưng tụ"),
            ("fog_form", "Sương mù hình thành"),
            ("sun_heat", "Mặt trời đốt nóng"),
            ("evaporate", "Sương bay hơi, tan"),
        ]
        distractors = [
            ("rain", "Mưa rơi xuống"),
            ("wind", "Gió thổi mạnh"),
            ("freeze", "Nước đóng băng"),
        ]
