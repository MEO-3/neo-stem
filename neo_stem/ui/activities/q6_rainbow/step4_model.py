...
class Step4Model(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QtWidgets.QLabel("Mô hình: Cầu vồng hình thành")
        title.setAlignment(QtCore.Qt.AlignHCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 700;")

        description = QtWidgets.QLabel(
            "Kéo các ô vào đúng thứ tự để giải thích tại sao cầu vồng xuất hiện sau cơn mưa.")
        ...
        self._drop_labels = ["Nguồn sáng", "Bước 1", "Bước 2", "Bước 3", "Kết quả"]
    ...
    def _setup_items(self) -> None:
        self._correct_sequence = [
            ("white_light", "Ánh sáng trắng"),
            ("enter_drop", "Vào giọt nước"),
            ("refract", "Khúc xạ tách màu"),
            ("reflect", "Phản xạ bên trong"),
            ("rainbow", "7 màu = Cầu vồng"),
        ]
        distractors = [
            ("dye", "Giọt nước nhuộm màu"),
            ("sun_change", "Mặt trời đổi màu"),
            ("illusion", "Mắt tạo ảo giác"),
        ]
